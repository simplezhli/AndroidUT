...
class LoginDaggerPresenterTest {

    private lateinit var mPresenter: LoginDaggerPresenter

    @Mock
    lateinit var mvpView: LoginMvpView
    ...
    fun setUp() {
        ...
        mPresenter = LoginDaggerPresenter(MyApp.instance.githubApi)
