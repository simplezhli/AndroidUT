...
class LoginDaggerActivityTest {

    private lateinit var loginActivity: LoginDaggerActivity
    ...
    fun setUp() {
        ...
        loginActivity = Robolectric.setupActivity(LoginDaggerActivity::class.java)
