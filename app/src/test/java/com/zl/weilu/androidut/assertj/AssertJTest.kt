...
class AssertJTest {
    ...
    fun testDate() {
        ...
        // 断言两时间相差100毫秒
        val d1 = Date()
        val d2 = Date(d1.time + 100)
        assertThat(d1).isCloseTo(d2, 100)

        val date1 = parseDatetimeWithMs("2018-01-01T01:00:00.000")
        val date2 = parseDatetimeWithMs("2018-01-01T01:00:00.555")
        val date3 = parseDatetimeWithMs("2018-01-01T01:00:55.555")
        val date4 = parseDatetimeWithMs("2018-01-01T01:55:55.555")
        val date5 = parseDatetimeWithMs("2018-01-01T05:55:55.555")
    ...
    fun testList() {
        // 断言 列表是空的
        assertThat(newArrayList<Int>()).isEmpty()
        // 断言 列表的开始 结束元素
        assertThat(newArrayList(1, 2, 3)).startsWith(1)
        assertThat(newArrayList(1, 2, 3)).endsWith(3)
        // 断言 列表包含元素 并且是排序的
        assertThat(newArrayList(1, 2, 3)).contains(1, atIndex(0))
        assertThat(newArrayList(1, 2, 3)).contains(2, atIndex(1))
        assertThat(newArrayList(1, 2, 3)).contains(3).isSorted()
        // 断言 被包含与给定列表
