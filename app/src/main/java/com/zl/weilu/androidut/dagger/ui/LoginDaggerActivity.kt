...
class LoginDaggerActivity : BaseMVPDaggerActivity<LoginMvpView, LoginDaggerPresenter>(), LoginMvpView, View.OnClickListener {
    ...
    override fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.tv_login ->
                mPresenter.login(et_mobile.text.toString().trim { it <= ' ' },
